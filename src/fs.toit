...
*/
is-absolute path/string --path-platform/string=system.platform -> bool:
...
```
*/
is-rooted path/string --path-platform/string=system.platform -> bool:
  if is-absolute path: return true
  if path-platform != system.PLATFORM-WINDOWS: return false
  if path.starts-with "\\" or path.starts-with "/": return true
...
*/
is-relative path/string --path-platform/string=system.platform -> bool:
...
*/
dirname path/string --path-platform/string=system.platform -> string:
  search-path := path
  if path-platform == system.PLATFORM-WINDOWS:
...
*/
canonicalize path/string --path-platform/string=system.platform -> string:
  start-index := 0
  if path-platform == system.PLATFORM-WINDOWS:
